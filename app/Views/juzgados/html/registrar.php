            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-primary">
                  ...
                  $item_centro_poblado    = '';
                  if ( $juzgados == null ) {
                    $action = base_url('juzgado/insertar');
                    $item_id = 0;
                  } else {
                    $action = base_url('juzgado/guardar');
                    $item_id = $juzgados->id_juzgado;
                    $item_id_tipo = $juzgados->id_tipo;
                    $item_nombre_tipo = $juzgados->nombre_tipo;
                    $item_id_distrito = $juzgados->id_distrito;
                    $item_id_provincia = $juzgados->id_provincia;
                    $item_descripcion_distrito = $juzgados->descripcion_distrito;
                    $item_nombre_juzgado = $juzgados->nombre_juzgado;
                    $item_centro_poblado = $juzgados->centro_poblado;
                    $item_comp_territorial = $juzgados->competencia_territorial;
                  }
                  ?>
